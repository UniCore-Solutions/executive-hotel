/** Render an invoice as a standalone, printable HTML document for download —
    same "build a string, blob-download it" pattern as `lib/ics.ts`. No PDF
    library exists anywhere in this repo yet; a browser can already turn a
    clean printable page into a PDF via its own print dialog. */
...
<body>
  ...
  <p class="muted" style="margin-top: 32px;">Thank you for staying with us.</p>
</body>
</html>`;
}
